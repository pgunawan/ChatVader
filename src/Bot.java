...
public class Bot {
	...
	private static String Question(String input) throws IOException{
		...
		if(input.contains("who")){
			...
			randString="Are you ready to join the darkside?";}
		else if(input.contains("joke")||synonyms.syn(input,"joke")){
		...
		else if(input.contains("regret")||synonyms.syn(input,"regret")){
	...
	private static String stressVader2(String input) throws IOException{
